...
func main() {
	...
	var (
		...
		bookingHandler = api.NewBookingsHandler(store)
	...
	v1.Get("/bookings/:id", bookingHandler.HandleGetBooking)
	v1.Get("/bookings/:id/cancel", bookingHandler.HandleCancelBooking)
